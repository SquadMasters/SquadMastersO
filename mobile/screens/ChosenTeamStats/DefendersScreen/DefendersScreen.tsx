...
const DefendersScreen = ({ route, navigation }:any) => {
    ...
    if (error) {
        return (
            <View style={styles.container}>
                <Text style={styles.error}>Fehler beim Laden der Verteidiger: {error}</Text>
                <TouchableOpacity
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.headerTitle}>Verteidiger</Text>
            ...
            {defenders.length > 0 ? (
                ...
                <View style={styles.noPlayersContainer}>
                    <Text style={styles.noPlayersText}>Keine Verteidiger für dieses Team gefunden</Text>
                    <TouchableOpacity
                        style={[styles.button, styles.accentButton, { marginTop: 20 }]}
                        onPress={() => navigation.goBack()}
                    >
