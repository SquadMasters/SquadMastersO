...
const AllPlayersScreen = ({ route, navigation }:any) => {
    ...
    if (error) {
        return (
            <View style={styles.container}>
                <Text style={styles.error}>Fehler beim Laden der Spieler: {error}</Text>
                <TouchableOpacity
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.headerTitle}>Alle Spieler</Text>
            ...
            {players.length > 0 ? (
                ...
                <View style={styles.noPlayersContainer}>
                    <Text style={styles.noPlayersText}>Keine Spieler für dieses Team gefunden</Text>
                    <TouchableOpacity
                        style={[styles.button, styles.accentButton, { marginTop: 20 }]}
                        onPress={() => navigation.goBack()}
                    >
